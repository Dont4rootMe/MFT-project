"""Entry point for running the streaming z-score mean reversion baseline."""
...
try:
    import torch
except ImportError:  # pragma: no cover - torch is optional for this pipeline.
    torch = None

LOGGER = logging.getLogger("zscore_baseline")
...
def main(config_path: Optional[str] = None) -> None:
    ...
    output_dir = Path(config.get("output_dir", "pipelines/z_score_mean_reversion/outputs"))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run the z-score mean reversion baseline strategy")
